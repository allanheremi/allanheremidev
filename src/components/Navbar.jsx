...
import { allan, menu, close } from '../assets';
...
const Navbar = () => {
  ...
  return (
    <nav
      className={`
    ${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-tertiary bg-opacity-70 lg:py-4
    `}
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          <img src={'src/assets/allan.png'} alt="logo" className="w-9 h-9 object-contain" />
